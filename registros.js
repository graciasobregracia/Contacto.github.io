...
import { collection, getFirestore, onSnapshot, orderBy, query } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js";
import { allowedViewerEmails, firebaseConfig, isFirebaseConfigured } from "./firebase-config.js";
...
function isAllowedEmail(email) {
    return allowedViewerEmails.map((item) => item.toLowerCase()).includes(String(email || "").toLowerCase());
}
